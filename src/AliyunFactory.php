...
class AliyunFactory
{
    ...
    public function createClient(array $config): OssClient
    {
        ...
        $client = new OssClient($config['access_key_id'], $config['access_key_secret'], $ossEndpoint, $config['is_cname'] ?? false, $config['security_token'] ?? null, $config['security_token'] ?? null);
